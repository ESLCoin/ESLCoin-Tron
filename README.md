...
## ESL Coin Tron - English As A Second Language

ESL Coin TRX is a the Tron based implementation of [ESL Coin](http://eslcoin.org), a community project that is set to disrupt the 84 Billion dollar language learning industry.
...
Globalization and the rise of technology have allowed many to have access to the internet. One of our goals is to make English learning accessible from anywhere in the world regardless of social economic background. We seek to create a blockchain system that removes inefficiencies and provide the benefits of blockchain to the language learning space.

## Team
The ESL Coin team consists of language teachers, community builders and developers with a passion to make English learning a possibility to everyone around the world regardless of socio econoimc backgrounds. As long as you have a phone and internet connection, you can be connected to a global network of native speakers who can help you learn and become more fluent at communicating in English.

## Opportunity
ESL Coin Tron seeks to create a Tron based blockchain ecosystem that will be based around the token, ESL Coin.

## Roadmap
The ecosystem will be launched in multiple phases:

1. Technical Launch
2. dApp ecosystem development
3. Public launch
4. Global rollout
5. Cross chain compatability
...
Using ESLCoin Tron, micropayments can be made possible without the worries of high gas fees on the Ethereum platform. 
